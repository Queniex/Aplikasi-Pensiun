  ...
  <header>
    <div class="py-8 bg-tema">
      <div class="flex text-white relative"> 
        ...
        <a href="register.html" class="absolute right-12"><button class="bg-yellow-600 px-5 py-2 rounded-full text-slate-800 font-semibold font-family-inter block mx-auto hover:text-slate-900 hover:bg-yellow-500 active:bg-yellow-600 focus:ring focus:ring-sky-900">Register</button></a>
      </div>
    </div>
  </header>
